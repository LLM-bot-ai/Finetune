...
class ReturnPredictionTrainer(Trainer):
    ...
    def compute_loss(
        ...
        representation = outputs.to(dtype=torch.float)
    ...
    def train(self):
        ...
        for epoch in range(int(self.args.num_train_epochs)):
            ...
            if val_loss < self.best_val_loss - self.early_stopping_threshold:
                ...
                logger.info(f"Validation loss did not improve, patience counter: {self.patience_counter}")

            if self.patience_counter >= 5 #early_stopping_patience:
...
def main():
    ...
    trainer = ReturnPredictionTrainer(
        ...
        early_stopping_patience=custom_args.early_stopping_patience,
        early_stopping_threshold=custom_args.early_stopping_threshold,
    )
