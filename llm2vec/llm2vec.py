...
class LLM2Vec(nn.Module):
    ...
    def forward(self, sentence_feature: Dict[str, Tensor]):
        embed_mask = None
        #print("sentence_feature", sentence_feature)
    ...
    def save(self, output_path, merge_before_save=False, save_config=True):
        ...
        self.model.save_pretrained("/content/drive/MyDrive/llm2vec-main2/output") #output_path)
        self.tokenizer.save_pretrained("/content/drive/MyDrive/llm2vec-main2/output")#(output_path)
        ...
        if save_config:
            ...
            with open(f"/content/drive/MyDrive/llm2vec-main2/output/llm2vec_config.json", "w") as fOut:
